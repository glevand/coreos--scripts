...
PORTAGE_BINHOST="http://builds.developer.core-os.net/boards/${BOARD}/${COREOS_VERSION}/pkgs/
http://builds.developer.core-os.net/boards/${BOARD}/${COREOS_VERSION}/toolchain/"
EOF
